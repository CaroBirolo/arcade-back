...
import { ObtenerComentarios, CrearComentario } from "./endpoints/comentarios";
...
const allowedOrigins = [
  "https://FREECLASSICGAMESONLINE.CC",
  "https://www.FREECLASSICGAMESONLINE.CC",
];
...
openapi.get("/api/comentarios", ObtenerComentarios);
openapi.post("/api/comentarios", CrearComentario);
